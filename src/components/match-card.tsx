...
import { type Fixture, formatDateTime, teamName } from "@/lib/data";
  ...
  return (
    <article className="rounded-md border border-zinc-200 bg-white p-4 shadow-sm">
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3 text-sm">
        <Link href={`/teams/${fixture.homeTeamSlug}`} className="font-bold text-zinc-950">{teamName(fixture.homeTeamSlug)}</Link>
        ...
        <Link href={`/teams/${fixture.awayTeamSlug}`} className="text-right font-bold text-zinc-950">{teamName(fixture.awayTeamSlug)}</Link>
      </div>
